    ...
    <div class="grid md:grid-cols-2 gap-x-6 gap-y-5 pl-10">
        <div class="md:col-span-2 space-y-2">
            ...
            <Textarea
                ...
                required
                class="bg-slate-50 focus:border-emerald-500 min-h-[80px]"
            />
        </div>
        <div class="space-y-2">
            <Label class="text-slate-600 font-medium"
                >Nama Kegiatan Kepanitiaan</Label
            >
            <Input
        ...
        >
            <label class="flex items-center gap-3 cursor-pointer group w-max">
                <div
                    class="relative flex items-center justify-center w-5 h-5 border-2 border-slate-300 rounded overflow-hidden group-hover:border-emerald-500 transition-colors"
                >
                    <input
                        type="checkbox"
                    ...
                    />
                    <svg
                        class="w-3.5 h-3.5 text-white bg-emerald-500 w-full h-full p-0.5 opacity-0 peer-checked:opacity-100 transition-opacity"
                ...
                <span
                    class="text-slate-700 font-semibold select-none group-hover:text-emerald-600 transition-colors"
                ...
                >
                    ...
                    >
                        <Button
                            ...
                            variant="outline"
                            onclick={addAlat}
                            class="text-emerald-600 border-emerald-200 hover:bg-emerald-50 text-xs font-semibold rounded-lg px-4 gap-2"
                        >
                            + Tambah Alat
                        </Button>
                    </div>
