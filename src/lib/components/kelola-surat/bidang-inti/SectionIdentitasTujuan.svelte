...
<section>
    ...
    <div class="grid md:grid-cols-2 gap-x-6 gap-y-5 pl-10">
        <div class="space-y-2 md:col-span-2">
            ...
            <div class="flex items-center gap-2">
                <Input
                    ...
                    placeholder="001"
                    required
                    class="w-20 bg-slate-50 focus:border-blue-500 text-center"
                />
                <span class="text-slate-400 font-bold">/</span>
                <select
                    bind:value={jenisSurat}
                    class="flex h-10 rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shrink-0 w-[220px]"
                >
                ...
                <Input
                    ...
                    placeholder="UKMK-YDK/III/2024"
                    required
                    class="flex-1 min-w-0 bg-slate-50 focus:border-blue-500"
                />
            </div>
            <p class="text-xs text-slate-500 mt-1">
                Preview Surat: <strong class="text-blue-700">{noSurat}</strong>
            </p>
        </div>
        <div class="space-y-2">
        ...
        <div class="space-y-2">
            ...
            <Input
                bind:value={perihal}
                placeholder="Contoh: Undangan Rapat / Peminjaman Alat"
                required
                class="bg-slate-50 focus:border-blue-500"
            />
        </div>
        <div class="space-y-2">
            ...
            <Input
                ...
                bind:value={tglSurat}
                required
                class="block bg-slate-50 focus:border-blue-500 w-full"
            />
        </div>
        <div class="space-y-2">
            ...
            <div class="space-y-2">
                {#each tujuanList as tujuan, index}
                    <div class="flex items-center gap-2">
                        <Input
                            ...
                            placeholder="Contoh: Wakil Rektor III ITB Yadika Pasuruan"
                            required
                            class="bg-slate-50 focus:border-blue-500 flex-1"
                        />
                        {#if tujuanList.length > 1}
                            <button
                                type="button"
                ...
                <button
                    type="button"
                    class="text-sm text-blue-600 font-medium hover:text-blue-700 flex items-center gap-1 mt-1"
                    onclick={addTujuan}
                >
